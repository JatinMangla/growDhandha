...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      data-cta="floating"
      // While faded out it must also leave the tab order and the accessibility
      // tree — opacity alone left an invisible, focusable link.
      inert={!visible}
      className={cn(
        'fixed bottom-5 right-5 z-50 flex items-center gap-2.5 rounded-pill bg-whatsapp px-4 py-3.5 text-sm font-semibold text-on-whatsapp shadow-lift-lg transition-all duration-300 ease-entrance hover:scale-105 sm:bottom-7 sm:right-7',
